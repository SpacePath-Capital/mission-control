...
export default function PortfolioPage() {
  ...
  return (
    <div className="relative h-screen" style={{ margin: 0, padding: 0, backgroundColor: 'black' }}>
      ...
      <iframe
        src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQWqC6_q0vrGbsrJq130ZraEgUhZM-z7KGe3tmFYg0pkffkKqL8cx706eYFQwfAWtnZZVNL5J-O9QIe/pubhtml?gid=630357522&single=true&widget=false&headers=false&rm=embedded&output=embed"
