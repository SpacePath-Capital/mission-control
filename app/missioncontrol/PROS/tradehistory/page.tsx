...
export default function TradeHistoryPage() {
  useEffect(() => {
    const interval = setInterval(() => {
      const iframe = document.getElementById('tradehistory-iframe') as HTMLIFrameElement | null;
  ...
  return (
    <div className="relative h-screen" style={{ margin: 0, padding: 0, backgroundColor: 'black' }}>
      ...
      <ProsNav />
      <iframe
        id="tradehistory-iframe"
        src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQWqC6_q0vrGbsrJq130ZraEgUhZM-z7KGe3tmFYg0pkffkKqL8cx706eYFQwfAWtnZZVNL5J-O9QIe/pubhtml?gid=638477160&single=true&widget=false&headers=false&rm=embedded&output=embed"
