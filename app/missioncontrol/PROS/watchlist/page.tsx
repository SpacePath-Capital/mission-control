...
export default function WatchlistPage() {
  useEffect(() => {
    const interval = setInterval(() => {
      const iframe = document.getElementById('watchlist-iframe') as HTMLIFrameElement | null;
  ...
  return (
    <div className="relative h-screen" style={{ margin: 0, padding: 0, backgroundColor: 'black' }}>
      ...
      <iframe
        id="watchlist-iframe"
        src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQWqC6_q0vrGbsrJq130ZraEgUhZM-z7KGe3tmFYg0pkffkKqL8cx706eYFQwfAWtnZZVNL5J-O9QIe/pubhtml?gid=2034183658&single=true&widget=false&headers=false&rm=embedded&output=embed"
